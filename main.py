            ...
            if selected_tile:
                ...
                if selected_tower.level < len(TOWER_DATA[selected_tower.tower_type]):
                    ...
                    match selected_tower.tower_type:
                        case "basic" | "sniper" | "cannon":
                            draw_text(
                                f'damage: {round(selected_tower.get_attribute(selected_tower.level - 1, "damage"), 2)} -> {round(selected_tower.get_attribute(selected_tower.level, "damage"), 2)}',
                                text_font, "black", c.SCREEN_WIDTH + 5, 180)
                            draw_text(
                                f'range: {round(selected_tower.get_attribute(selected_tower.level - 1, "range"), 2)} -> {round(selected_tower.get_attribute(selected_tower.level, "range"), 2)}',
                                text_font, "black", c.SCREEN_WIDTH + 5, 210)
                            draw_text(
                                f'attack speed: {round(selected_tower.get_attribute(selected_tower.level - 1, "atk_speed"), 2)} -> {round(selected_tower.get_attribute(selected_tower.level, "atk_speed"), 2)}',
                                text_font, "black", c.SCREEN_WIDTH + 5, 240)
                        case "freeze":
                            draw_text(
                                f'slow rate: {1 - selected_tower.get_attribute(selected_tower.level - 1, "slow_rate"):.2f} -> {1 - selected_tower.get_attribute(selected_tower.level, "slow_rate"):.2f}',
                                text_font, "black", c.SCREEN_WIDTH + 5, 180)
                            draw_text(
                                f'range: {round(selected_tower.get_attribute(selected_tower.level - 1, "range"), 2)} -> {round(selected_tower.get_attribute(selected_tower.level, "range"), 2)}',
                                text_font, "black", c.SCREEN_WIDTH + 5, 210)
                    ...
                    match selected_tower.tower_type:
                        case "basic" | "sniper" | "cannon":
                            draw_text(f'damage: {round(selected_tower.get_attribute(selected_tower.level - 1, "damage"), 2)}', text_font, "black", c.SCREEN_WIDTH + 5, 180)
                            draw_text(f'range: {round(selected_tower.get_attribute(selected_tower.level - 1, "range"), 2)}', text_font, "black", c.SCREEN_WIDTH + 5, 210)
                            draw_text(
                                f'attack speed: {round(selected_tower.get_attribute(selected_tower.level - 1, "atk_speed"), 2)}',
                                text_font, "black", c.SCREEN_WIDTH + 5, 240)
                        case "freeze":
                            draw_text(f'slow rate: {1 - selected_tower.get_attribute(selected_tower.level - 1, "slow_rate"):.2f}', text_font, "black", c.SCREEN_WIDTH + 5, 180)
                            draw_text(f'range: {round(selected_tower.get_attribute(selected_tower.level - 1, "range"), 2)}', text_font, "black", c.SCREEN_WIDTH + 5, 210)
